    ...
    if (settings.systemPrompt) {
      ...
      sections.push(
        [
          ...
          "- Nao ofereca handoff humano por padrao. So ofereca quando o usuario pedir isso explicitamente ou quando faltar uma confirmacao interna indispensavel para responder.",
          ...
          "- Antes de oferecer handoff, responda com o que ja estiver confirmado no contexto. Se algo ainda nao estiver confirmado, deixe isso claro sem empurrar para humano cedo demais.",
