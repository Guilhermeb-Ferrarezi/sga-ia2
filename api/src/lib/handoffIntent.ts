...
const HANDOFF_OFFER_PATTERNS = [
  /\bquer que eu (?:ja )?(?:faca isso|encaminhe|passe|verifique com a equipe|confirme com a equipe|solicite a confirmacao com a equipe)\b/i,
  /\b(?:posso|vou) (?:ja )?(?:encaminhar|passar|verificar com a equipe|confirmar com a equipe)\b/i,
